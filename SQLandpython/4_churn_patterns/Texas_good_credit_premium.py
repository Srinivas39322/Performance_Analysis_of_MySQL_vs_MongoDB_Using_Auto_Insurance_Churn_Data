...
#Identifying Churn Patterns in Auto Insurance Data for Customers in Texas with Children, Good Credit, and Premiums Over $1000"
...
WHERE
    Churn = 1
    AND state = 'TX' -- Replace 'TX' with the desired state
    AND has_children = 1
    AND good_credit = 1
    AND curr_ann_amt > 1000
ORDER BY
    days_tenure DESC;
